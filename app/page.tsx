            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  title: "AI面试刷题助手",
                  subtitle: "AI 学习产品",
                  desc: "面向AI行业转型求职人群，设计并开发AI面试刷题助手，解决传统面试准备方式缺乏反馈、学习路径不清晰等问题。通过构建结构化AI产品经理面试知识库，结合大模型能力实现用户回答智能评测，从内容完整性、技术理解、产品思维、表达逻辑等维度提供针对性反馈，帮助用户从标准化刷题转向个性化能力提升。同时基于历史答题数据构建用户成长曲线，追踪能力变化趋势，让用户直观看到学习效果并持续优化面试表现。",
